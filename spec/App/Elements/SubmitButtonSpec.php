...
class SubmitButtonSpec extends ObjectBehavior
{
    ...
    public function let()
    {
        ...
        $prophacy = $this->prophet->Prophesize('App\ViewHelpers\SubmitButton');

        $prophacy->display(['name' => 'test'])->willReturn('<input type="submit" name="test" value="" id="" class="" />');
    ...
    {
        $this->shouldHaveType('App\Elements\SubmitButton');
    }

    public function it_should_display()
    {
        $this->display()->shouldReturn('<input type="submit" name="test" value="" id="" class="" />');
    }
